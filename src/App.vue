...
.falling-heart:nth-child(12) {
  left: 60%;
  animation-duration: 4.6s;
  animation-delay: 0.5s;
}

.falling-heart:nth-child(13) {
  left: 65%;
  animation-duration: 4.1s;
  animation-delay: 0.2s;
  font-size: 29px;
...
.falling-heart:nth-child(14) {
  left: 70%;
  animation-duration: 3.8s;
  animation-delay: 0.4s;
}

.falling-heart:nth-child(15) {
  left: 75%;
  animation-duration: 4.3s;
  animation-delay: 0.1s;
  font-size: 21px;
...
.falling-heart:nth-child(16) {
  left: 80%;
  animation-duration: 4.5s;
  animation-delay: 0.3s;
}

.falling-heart:nth-child(17) {
  left: 85%;
  animation-duration: 4.0s;
  animation-delay: 0.2s;
  font-size: 25px;
...
.falling-heart:nth-child(18) {
  left: 90%;
  animation-duration: 4.2s;
  animation-delay: 0.4s;
}

.falling-heart:nth-child(19) {
  left: 95%;
  animation-duration: 4.4s;
  animation-delay: 0.1s;
  font-size: 22px;
